...
This is a project and proof of concept, it has failed to prevent some prompt injections in trials (57% of malicious prompts, see Quantative_Report.md). USE AT OWN RISK 
